...
export default new LocalizedStrings({
    ...
    reactDeveloper: 'React devaaja',
    reactIsMyThing: 'React on mun juttu!',
    introParagraph1: 'Ihastuin Reactiin jo 2015, josta asti olemme olleet parhaita kavereita. Olen tehnyt web-projekteja Reactilla, että mobiiliprojekteja React Nativella. Funktionaalinen ohjelmointi on iso osa ohjelmointityyliäni, koska se tekee koodista usein kaunista ja testattavaa.',
    ...
    clothCardDescription: 'Tämän GitHubissa olevan vapaa-ajanprojektin tarkoituksena oli kokeilla minkälaisia hyödyllisia animaatioita React Nativella saa tehtyä. Vivamus mollis consectetur metus, mollis euismod nisi hendrerit vitae.',
    shouldWeStartWorking: 'Aloitetaanko hommat?',
    hereIsPictureOfMe: 'Tässä vielä kuva niin tunnistat kun nähdään!',
  },
  en: {
    myName: 'Henrik Raitasola',
