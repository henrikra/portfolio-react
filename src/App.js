      ...
      <div className="App">
        ...
        <section className="next-section">
          <div className="container">
            ...
            <p>Ihastuin Reactiin jo 2015 vuonna ja siitä asti olemme olleet parhaita kavereita. Nyt hänen kanssaan on tullut tehtyä projekteja web maailmassa sekä mobiilikehityksessä React Nativen avulla. Fusce turpis tortor, ultricies quis neque vel, porta aliquet lacus. Pellentesque id arcu a ligula tincidunt efficitur vitae et nunc.</p>
